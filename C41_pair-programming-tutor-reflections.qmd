...
> Pair programming is a strategy that prioritises learning the process of coding as opposed to just the end product.
...
> Mixed-ability pairings are productive, but it is important to monitor the contributions of each student.
...
> Although collaborative learning is a valuable skill, it can be undermined if students see their classmates as competitors.

## Facilitation of Pair Programming as a Tutor
...
> As a PhD tutor, pair programming allowed me to share my own strategies during these sessions and also learn new approaches from the students, showing that learning is richest when multiple perspectives are shared at every level.
